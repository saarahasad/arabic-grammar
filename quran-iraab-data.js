    ...
    rows: [
      ...
      },
      {
        ...
        analysisParts: [
          ...
          { type: 'text', text: ' مُتَعَلِّقَانِ بِ«تَحَدَّثَ»' },
        ],
      },
    ],
  },
  {
    ...
    rows: [
      ...
      },
      {
        ...
        analysisParts: [
          { type: 'link', text: 'مَفْعُولٌ بِهٍ', rule: 'mafool' },
          { type: 'text', text: '؛ والمصدر المؤول مِنْ أَنَّ وما بعدها فِي مَحَلِّ جَرٍّ بِاللَّامِ؛ الْجَارُ وَالْمَجْرُورُ مُتَعَلِّقَانِ بِ«يَصْدُرُ»' },
        ],
      },
    ],
  },
    ...
    rows: [
      ...
      },
      {
        ...
        analysisParts: [
          ...
          { type: 'link', text: "ضَمِيرٌ مُتَّصِلٌ", rule: "attached-pronouns" },
          { type: 'text', text: " مَبْنِيٌّ عَلَى الضَّمِّ فِي مَحَلِّ نَصْبِ مَفْعُولٌ بِهٍ أَوَّلٌ، وَالْفَاعِلُ ضَمِيرٌ مُسْتَتِرٌ تَقْدِيرُهُ «هو»، والمصدر المؤول مِنْ «أَنَّ» وَالْفِعْلُ فِي مَحَلِّ جَرٍّ بِحَرْفٍ مَحْذُوفٍ وَالتَّقْدِيرُ لِرُؤْيَةِ نَفْسِهِ مُسْتَغْنِيًا — انظر " },
  ...
  },
  {
    ...
    rows: [
      ...
      },
      {
        ...
        analysisParts: [
                    { type: 'link', text: "مَجْرُورٌ", rule: "irab-jarr" },
          { type: 'text', text: " بِالْكَسْرَةِ الْمُقَدَّرَةِ؛ وَشِبْهُ جُمْلَةٍ فِي مَحَلِّ نَصْبِ خَبَرِ كَانَ؛ وَجَوَابُ الشَّرْطِ مَحْذُوفٌ" },
        ],
      },
    ],
  },
    ...
    rows: [
      ...
      },
      {
        ...
        analysisParts: [
          ...
          { type: 'link', text: "مَجْرُورٌ", rule: "irab-jarr" },
          { type: 'text', text: " بِالْكَسْرَةِ الْمُقَدَّرَةِ" },
        ],
      },
    ],
  },
    ...
    rows: [
      ...
      },
      {
        ...
        analysisParts: [
          ...
          { type: 'link', text: "فِعْلٌ مَاضٍ", rule: "verb-past" },
          { type: 'text', text: " مَبْنِيٌّ عَلَى الْفَتْحِ الْمُقَدَّرِ لِلتَّعَذُّرِ، وَالْفَاعِلُ ضَمِيرٌ مُسْتَتِرٌ تَقْدِيرُهُ «هو»، وَجَوَابُ الشَّرْطِ مَحْذُوفٌ." },
        ],
      },
    ],
  },
  ...
  },
{
  ...
  },
  {
    ...
    rows: [
      {
        segment: 'وَٱلَّيْلِ إِذَا يَغْشَىٰ',
        analysisParts: [
          {
            type: 'text',
            text:
              '﴿وَاللَّيْلِ إِذَا﴾: أعربت في الآية الثانية من سورة "الشمس".\nوهو : « وَالْقَمَرِ: الواو: حرف جرّ للقسم.\n﴿القمر﴾: مقسم به مجرور بالكسرة، والجارّ والمجرور متعلّقان بفعل القسم المحذوف.\n﴿ إِذَا﴾: ظرف زمان مبنيّ على السكون في محلّ نصب متعلّق بحال محذوفة من القمر، ».\n﴿يَغْشَى﴾: فعل مضارع مرفوع بالضمة المقدّرة على الألف للتعذّر.\nوجملة "يغشي" في محلّ جرّ بالإضافة.',
          },
        ],
      },
    ],
  ...
  },
  {
    ...
    rows: [
      {
        segment: 'وَمَا خَلَقَ ٱلذَّكَرَ وَٱلْأُنثَىٰٓ',
        analysisParts: [
          {
            type: 'text',
            text:
  ...
  },
  {
    ...
    rows: [
      {
        segment: 'إِنَّ سَعْيَكُمْ لَشَتَّىٰ',
        analysisParts: [
          {
            type: 'text',
            text:
  ...
  },
  {
    ...
    rows: [
      {
        segment: 'فَأَمَّا مَنْ أَعْطَىٰ وَٱتَّقَىٰ',
        analysisParts: [
          {
            type: 'text',
            text:
  ...
  },
  {
    ...
    rows: [
      {
        segment: 'وَصَدَّقَ بِٱلْحُسْنَىٰ',
        analysisParts: [
          {
            type: 'text',
            text:
  ...
  },
  {
    ...
    rows: [
      {
        segment: 'فَسَنُيَسِّرُهُۥ لِلْيُسْرَىٰ',
        analysisParts: [
          {
            type: 'text',
            text:
  ...
  },
  {
    ...
    rows: [
      {
        segment: 'وَأَمَّا مَنۢ بَخِلَ وَٱسْتَغْنَىٰ',
        analysisParts: [
          {
            type: 'text',
            text:
  ...
  },
  {
    ...
    rows: [
      {
        segment: 'وَكَذَّبَ بِٱلْحُسْنَىٰ',
        analysisParts: [
          {
            type: 'text',
            text:
              '﴿تعرب إعراب الآية السادسة.\nوهو ﴾: « وَصَدَّقَ: الواو: حرف عطف.\n﴿صدق﴾: فعل ماضٍ مبنيّ على الفتحة.\n﴿بِالْحُسْنَى﴾: جارّ ومجرور متعلّقان بـ"صدق"، وعلامة جرّ الاسم الكسرة المقدّرة على الألف للتعذّر».',
          },
        ],
      },
    ],
  },
  {
    ...
    rows: [
      {
        segment: 'فَسَنُيَسِّرُهُۥ لِلْعُسْرَىٰ',
        analysisParts: [
          {
            type: 'text',
            text:
  ...
  },
  {
    ...
    rows: [
      {
        segment: 'إِنَّ عَلَيْنَا لَلْهُدَىٰ',
        analysisParts: [
          {
            type: 'text',
            text:
  ...
  },
  {
    ...
    rows: [
      {
        segment: 'وَإِنَّ لَنَا لَلْـَٔاخِرَةَ وَٱلْأُولَىٰ',
        analysisParts: [
          {
            type: 'text',
            text:
  ...
  },
  {
    ...
    rows: [
      {
        segment: 'فَأَنذَرْتُكُمْ نَارًا تَلَظَّىٰ',
        analysisParts: [
          {
            type: 'text',
            text:
  ...
  },
  {
    ...
    rows: [
      {
        segment: 'لَا يَصْلَىٰهَآ إِلَّا ٱلْأَشْقَى',
        analysisParts: [
          {
            type: 'text',
            text:
  ...
  },
  {
    ...
    rows: [
      {
        segment: 'ٱلَّذِى كَذَّبَ وَتَوَلَّىٰ',
        analysisParts: [
          {
            type: 'text',
            text:
  ...
  },
  {
    ...
    rows: [
      {
        segment: 'وَسَيُجَنَّبُهَا ٱلْأَتْقَى',
        analysisParts: [
          {
            type: 'text',
            text:
  ...
  },
  {
    ...
    rows: [
      {
        segment: 'ٱلَّذِى يُؤْتِى مَالَهُۥ يَتَزَكَّىٰ',
        analysisParts: [
          {
            type: 'text',
            text:
  ...
  },
  {
    ...
    rows: [
      {
        segment: 'إِلَّا ٱبْتِغَآءَ وَجْهِ رَبِّهِ ٱلْأَعْلَىٰ',
        analysisParts: [
          {
            type: 'text',
            text:
