  ...
  /* —— سُورَةُ التِّينِ (٩٥) —— */
  {
    ...
    rows: [
      ...
      },
      {
        ...
        analysisParts: [
          { type: 'link', text: "الْوَاوُ", rule: "harf-jarr" },
          { type: 'text', text: " حَرْفُ جَرٍّ وقسم مَبْنِيٌّ عَلَى الْفَتْحِ، وَ«ٱلتِّينِ» اسْمٌ مَجْرُورٌ وَعَلَامَةُ جَرِّهِ الْكَسْرَةُ الظَّاهِرَةُ." },
        ],
      },
      {
        ...
        analysisParts: [
          { type: 'link', text: "الْوَاوُ", rule: "atf" },
          { type: 'text', text: " حَرْفُ عَطْفٍ مَبْنِيٌّ عَلَى الْفَتْحِ، وَ«ٱلزَّيْتُونِ» مَعْطُوفٌ مَجْرُورٌ وَعَلَامَةُ جَرِّهِ الْكَسْرَةُ الظَّاهِرَةُ." },
        ],
      },
    ],
  },
    ...
    rows: [
      {
        ...
        analysisParts: [
          { type: 'link', text: "الْوَاوُ", rule: "atf" },
          { type: 'text', text: " حَرْفُ عَطْفٍ مَبْنِيٌّ عَلَى الْفَتْحِ، وَ«طُورِ» مَعْطُوفٌ مَجْرُورٌ وَعَلَامَةُ جَرِّهِ الْكَسْرَةُ الظَّاهِرَةُ." },
        ],
      },
      {
        segment: "سِينِينَ",
        analysisParts: [
          { type: 'link', text: "مُضَافٌ إِلَيْهِ", rule: "idafah" },
          { type: 'text', text: " مَجْرُورٌ وَعَلَامَةُ جَرِّهِ الْفَتْحَةُ الظَّاهِرَةُ لِأَنَّهُ ممِنْوع مِنْ الصرف — انظر " },
    ...
    rows: [
      {
        ...
        analysisParts: [
          ...
          { type: 'link', text: "اسْمُ إِشَارَةٍ", rule: "demonstratives" },
          { type: 'text', text: " مَبْنِيٌّ عَلَى السُّكُونِ فِي مَحَلِّ جَرٍّ مَعْطُوفٌ." },
        ],
      },
      {
        segment: "ٱلْبَلَدِ",
        analysisParts: [
          { type: 'text', text: "بَدَلٌ مَجْرُورٌ وَعَلَامَةُ جَرِّهِ الْكَسْرَةُ الظَّاهِرَةُ." },
        ],
      },
      {
        segment: "ٱلْأَمِينِ",
        analysisParts: [
          { type: 'link', text: "نَعْتٌ", rule: "naat" },
          { type: 'text', text: " لِـ«ٱلْبَلَدِ» مَجْرُورٌ وَعَلَامَةُ جَرِّهِ الْكَسْرَةُ الظَّاهِرَةُ." },
        ],
      },
    ],
  },
    ...
    rows: [
      {
        segment: "لَقَدْ",
        analysisParts: [
          { type: 'text', text: "«اللَّامُ» حرف جواب للقسم مَبْنِيٌّ عَلَى الْفَتْحِ، وَ«قَدْ» حرف تحقيق مَبْنِيٌّ عَلَى السُّكُونِ." },
        ],
      },
      {
        segment: "خَلَقْنَا",
        analysisParts: [
          { type: 'link', text: "فِعْلٌ مَاضٍ", rule: "verb-past" },
          { type: 'text', text: " مَبْنِيٌّ عَلَى السُّكُونِ لِاتِّصَالِهِ ب«نَا» الفَاعِلٌين، و«نَا» " },
          { type: 'link', text: "ضَمِيرٌ مُتَّصِلٌ", rule: "attached-pronouns" },
    ...
    rows: [
      ...
      },
      {
        ...
        analysisParts: [
          ...
          { type: 'text', text: " مَبْنِيٌّ عَلَى السُّكُونِ لِاتِّصَالِهِ ب«نَا» الفَاعِلٌين، و«نَا» " },
          { type: 'link', text: "ضَمِيرٌ مُتَّصِلٌ", rule: "attached-pronouns" },
          { type: 'text', text: " مَبْنِيٌّ عَلَى السُّكُونِ فِي مَحَلِّ رَفْعِ فَاعِلٌ، و«هاء الغائب» " },
          { type: 'link', text: "ضَمِيرٌ مُتَّصِلٌ", rule: "attached-pronouns" },
          { type: 'text', text: " مَبْنِيٌّ عَلَى الضَّمِّ فِي مَحَلِّ نَصْبِ مَفْعُولٌ بِهٍ." },
        ],
      },
      {
        segment: "أَسْفَلَ",
      ...
      },
      {
        ...
        analysisParts: [
          { type: 'link', text: "مُضَافٌ إِلَيْهِ", rule: "idafah" },
          { type: 'text', text: " مَجْرُورٌ وَعَلَامَةُ جَرِّهِ اليَاء لِأَنَّهُ " },
          { type: 'link', text: "جَمْعُ الْمُذَكَّرِ السَّالِمِ", rule: "number-plural" },
          { type: 'text', text: "." },
        ],
      },
  ...
  },
  {
    ...
    rows: [
      ...
      },
      {
        segment: "فَلَهُمْ",
        analysisParts: [
          { type: 'text', text: "«الْفَاءُ» حَرْفُ رَابِطٍ مَبْنِيٌّ عَلَى الْفَتْحِ، وَ«اللَّامُ» " },
          { type: 'link', text: "حَرْفُ جَرٍّ", rule: "harf-jarr" },
          { type: 'text', text: " مَبْنِيٌّ عَلَى الْفَتْحِ، وَ«هَاءُ الْغَائِبِ» " },
          { type: 'link', text: "ضَمِيرٌ مُتَّصِلٌ", rule: "attached-pronouns" },
    ...
    rows: [
      {
        ...
        analysisParts: [
          { type: 'link', text: "الْفَاءُ", rule: "harf-maani" },
          { type: 'text', text: " حَرْفُ اسْتِئْنَافٍ مَبْنِيٌّ عَلَى الْفَتْحِ، وَ«مَا» " },
          { type: 'link', text: "اسْمُ اسْتِفْهَامٍ", rule: "interrogative-nouns" },
          { type: 'text', text: " مَبْنِيٌّ عَلَى السُّكُونِ فِي مَحَلِّ رَفْعِ مُبْتَدَأٍ." },
        ],
      },
      {
        ...
        analysisParts: [
          ...
          { type: 'text', text: " مَرْفُوعٌ وَعَلَامَةُ رَفْعِهِ الضَّمَّةُ الظَّاهِرَةُ، وَ«كَافُ الْمُخَاطَبِ» " },
          { type: 'link', text: "ضَمِيرٌ مُتَّصِلٌ", rule: "attached-pronouns" },
          { type: 'text', text: " مَبْنِيٌّ عَلَى الْفَتْحِ فِي مَحَلِّ نَصْبِ مَفْعُولٌ بِهٍ، وَالْفَاعِلُ ضَمِيرٌ مُسْتَتِرٌ تَقْدِيرُهُ «هو»، وَالْجُمْلَةُ فِي مَحَلِّ رَفْعِ خَبَرِ الْمُبْتَدَأِ «مَا»." },
        ],
      },
      {
        segment: "بَعْدُ",
        analysisParts: [
          { type: 'text', text: "ظَرْفُ زَمَانٍ مَبْنِيٌّ عَلَى الضَّمِّ فِي مَحَلِّ نَصْبٍ." },
        ],
      },
      {
        segment: "بِٱلدِّينِ",
        analysisParts: [
          { type: 'link', text: "الْبَاءُ", rule: "harf-jarr" },
          { type: 'text', text: " حَرْفُ جَرٍّ مَبْنِيٌّ عَلَى الْكَسْرِ، و«ٱلدِّينِ» اسْمٌ مَجْرُورٌ وَعَلَامَةُ جَرِّهِ الْكَسْرَةُ الظَّاهِرَةُ." },
        ],
      },
    ],
  },
  {
    ...
    rows: [
      ...
      },
      {
        ...
        analysisParts: [
          { type: 'link', text: "الْبَاءُ", rule: "harf-jarr" },
          { type: 'text', text: " حَرْفُ جَرٍّ زائد مَبْنِيٌّ عَلَى الْكَسْرِ، و«أَحْكَمِ» خَبَرٌ ليس مَجْرُورٌ لفظاً مَنْصُوبٌ محلًا وعَلَامَةُ جَرِّهِ الْكَسْرَةُ الظَّاهِرَةُ." },
        ],
      },
      {
  ...
  /* —— سُورَةُ الْقَدْرِ (٩٧) —— */
  {
    ...
    rows: [
      ...
      },
      {
        ...
        analysisParts: [
          { type: 'link', text: "إِنَّ", rule: "inna-sisters" },
          { type: 'text', text: " حَرْفُ تَوْكِيدٍ وَنَصْبٍ مَبْنِيٌّ عَلَى الْفَتْحِ، وَ«نَا» " },
          { type: 'link', text: "ضَمِيرٌ مُتَّصِلٌ", rule: "attached-pronouns" },
          { type: 'text', text: " مَبْنِيٌّ عَلَى السُّكُونِ فِي مَحَلِّ نَصْبِ اسم «إِنَّ»." },
        ],
      },
      {
        ...
        analysisParts: [
          ...
          { type: 'text', text: " مَبْنِيٌّ عَلَى السُّكُونِ فِي مَحَلِّ رَفْعِ فَاعِلٌ، و«هاء الغائب» " },
          { type: 'link', text: "ضَمِيرٌ مُتَّصِلٌ", rule: "attached-pronouns" },
          { type: 'text', text: " مَبْنِيٌّ عَلَى الضَّمِّ فِي مَحَلِّ نَصْبِ مَفْعُولٌ بِهٍ، وَالْجُمْلَةُ فِي مَحَلِّ رَفْعِ خَبَرٌ «إِنَّ»." },
        ],
      },
      {
        segment: "فِى",
  ...
  },
  {
    ...
    rows: [
      ...
      },
      {
        ...
        analysisParts: [
          { type: 'link', text: "خَبَرٌ", rule: "nominal-sentence" },
          { type: 'text', text: " مَرْفُوعٌ وَعَلَامَةُ رَفْعِهِ الضَّمَّةُ الظَّاهِرَةُ، وَالْجُمْلَةُ فِي مَحَلِّ نَصْبِ مَفْعُولٌ بِهٍ ثَانٍ لِـ«أَدْرَى»." },
        ],
      },
      {
        segment: "ٱلْقَدْرِ",
    ...
    rows: [
      {
        ...
        analysisParts: [
          { type: 'link', text: "فِعْلٌ مُضَارِعٌ", rule: "verb-present" },
          { type: 'text', text: " حذفت مِنْه إحدى التاءين " },
          { type: 'link', text: "مضاعف", rule: "verb-mudaaf" },
          { type: 'text', text: "؛ مَرْفُوعٌ وَعَلَامَةُ رَفْعِهِ الضَّمَّةُ الظَّاهِرَةُ." },
        ],
      },
      {
      ...
      },
      {
        ...
        analysisParts: [
          { type: 'link', text: "الْبَاءُ", rule: "harf-jarr" },
          { type: 'text', text: " حَرْفُ جَرٍّ مَبْنِيٌّ عَلَى الْكَسْرِ، و«إِذْنِ» اسْمٌ مَجْرُورٌ وَعَلَامَةُ جَرِّهِ الْكَسْرَةُ الظَّاهِرَةُ." },
        ],
      },
      {
        segment: "رَبِّهِم",
    ...
    rows: [
      {
        ...
        analysisParts: [
          { type: 'link', text: "خَبَرٌ", rule: "nominal-sentence" },
          { type: 'text', text: " مقدم مَرْفُوعٌ وَعَلَامَةُ رَفْعِهِ الضَّمَّةُ الظَّاهِرَةُ." },
        ],
      },
      {
        segment: "هِىَ",
        analysisParts: [
          { type: 'link', text: "ضَمِيرٌ مُنْفَصِلٌ", rule: "detached-pronouns" },
          { type: 'text', text: " مَبْنِيٌّ عَلَى الْفَتْحِ فِي مَحَلِّ رَفْعِ مُبْتَدَأٌ مُؤَخَّرٌ." },
        ],
      },
      {
        segment: "حَتَّىٰ",
